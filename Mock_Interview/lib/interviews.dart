...
class Interviewview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const InterviewviewPage(),
    );
  }
}

class InterviewviewPage extends StatefulWidget {
  const InterviewviewPage({Key? key}) : super(key: key);

  @override
  State<InterviewviewPage> createState() => _SInterviewviewPagePageState();
}

class _SInterviewviewPagePageState extends State<InterviewviewPage> {
  _SInterviewviewPagePageState(){
    // Profileview();
  }
  // String Name=" ";
  // String Place=" ";
